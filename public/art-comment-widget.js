...
*/
/*
  This is a modified version of Ayano's comment widget, I made this to fit it in my lightbox widget (viewer.js)!
*/
// The values in this section are REQUIRED for the widget to work! Keep them in quotes!
const s_formId = '1FAIpQLScysE-dcceRIqNkw2sDiWhJdSW0MbnzOjeYHBdDcQ__U6BgkA';
const s_nameId = '2072340107';
const s_websiteId = '1619165386';
const s_textId = '1480384855';
const s_pageId = '1461739271';
const s_replyId = '755922376';
const s_moderatedId = '510951818';
const s_sheetId = '1au14xPzmyLSAmPFmU-ihn-Mo1OjnHDl-ohacJ95DmVE';
...
const s_maxLength = 2500; // The max character length of a comment
...
const s_textFieldLabel = 'Comment your thoughts';
...
function getComments(filename) {
    ...
    retrievedSheet.then(result => {
        ...
        if (comments.length == 0 || Object.keys(comments[0]).length < 2) { // Once again, Google Sheets can be weird
            c_container.innerHTML = '<span class="nocomment">'+ s_noCommentsText +'</span>';
...
function openReply(id) {
    if (c_replyingText.style.display == 'none') {
        ...
        c_replyingText.style.display = 'inline-block';
    } else {
